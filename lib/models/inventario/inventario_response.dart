...
class InventarioResponse {
  ...
  factory InventarioResponse.fromMap(Map<String, dynamic> json) =>
      InventarioResponse(
        ...
        respuestaSap: json["respuestaSap"] == null
            ? null
            : RespuestaSap.fromMap(json["respuestaSap"]),
      );
...
class RespuestaSap {
  ...
  factory RespuestaSap.fromJson(String str) =>
      RespuestaSap.fromMap(json.decode(str));
  ...
  factory RespuestaSap.fromMap(Map<String, dynamic> json) => RespuestaSap(
        ...
        inventarios: json["inventarios"] == null
            ? []
            : List<InventarioSAP>.from(
                json["inventarios"]!.map((x) => InventarioSAP.fromMap(x))),
      );
...
class InventarioSAP {
  ...
  factory InventarioSAP.fromJson(String str) =>
      InventarioSAP.fromMap(json.decode(str));
  ...
  factory InventarioSAP.fromMap(Map<String, dynamic> json) => InventarioSAP(
        ...
        inventarioimdet: json["inventarioimdet"] == null
            ? []
            : List<InventarioIMDetSAP>.from(json["inventarioimdet"]!
                .map((x) => InventarioIMDetSAP.fromMap(x))),
      );
  ...
  Map<String, dynamic> toMap() => {
        ...
        "centro": centro,
        "aplicado": aplicado,
        "inventarioimdet": inventarioimdet == null
            ? []
            : List<dynamic>.from(inventarioimdet!.map((x) => x.toMap())),
      };
}
...
class InventarioIMDetSAP {
  ...
  factory InventarioIMDetSAP.fromJson(String str) =>
      InventarioIMDetSAP.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory InventarioIMDetSAP.fromMap(Map<String, dynamic> json) =>
      InventarioIMDetSAP(
        umeSap: json["umeSAP"],
        ...
        inventarioimser: json["inventarioimser"] == null
            ? []
            : List<dynamic>.from(json["inventarioimser"]!.map((x) => x)),
      );
  ...
  Map<String, dynamic> toMap() => {
        ...
        "inventarioimser": inventarioimser == null
            ? []
            : List<dynamic>.from(inventarioimser!.map((x) => x)),
      };
}
...
class IMdetalle {
  ...
  factory IMdetalle.fromMap(Map<String, dynamic> json) => IMdetalle(
        ...
        descripcion: json["descripcion"],
        umeComercial: json["umeComercial"],
        cantidad: (json["cantidad"] is int || json["cantidad"] is double)
