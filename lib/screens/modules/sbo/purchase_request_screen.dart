...
class _PurchaseRequestState extends State<PurchaseRequest> {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<PurchaseRequestProvider>(
                              ...
                              children: [
                                TextFormField(
                                  ...
                                  onTap: () async {
                                    ...
                                    final isProductionItem =
                                        itemProvider.itemSelected.inCostRollup;
                                    print(
                                ...
                                const SizedBox(height: 15),
                                MaterialButton(
                                  onPressed: (purchaseRequestProvider.isLoading)
                                      ? null
                                      : () async {
                        ...
                        child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return Dismissible(
                                ...
                                child: PositionCard(line: documentLine),
                              );
                            }),
                      ),
                    ],
...
class PositionCard extends StatelessWidget {
  ...
  const PositionCard({super.key, required this.line});
